...
<script>
import Vue from 'vue';
import { NavBar, Overlay, Sticky, ActionSheet, Popup, DatetimePicker,Icon } from 'vant';
Vue.use(Overlay).use(Sticky).use(ActionSheet).use(Popup).use(DatetimePicker).use(NavBar).use(Icon);
Vue.use(Sticky);
Vue.use(Overlay);
export default {
    data() {
